...
For more information, please refer to the [SiT Dataset official page]((https://spalaboratory.github.io/SiT/)) or the [GitHub repository]((https://github.com/SPALaboratory/SiT-Dataset.git)).
